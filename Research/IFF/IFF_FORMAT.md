...
Because IFFs lack bone names, animation exporters must rely on hardcoded bone names based on the skeleton variation. There are two standard variations of skeletons:
